...
/***/ function(module, exports, __webpack_require__) {
	...
	var _refluxStore = __webpack_require__(202);

	var _refluxStore2 = _interopRequireDefault(_refluxStore);

	var _refluxActions = __webpack_require__(223);

	var _refluxActions2 = _interopRequireDefault(_refluxActions);

	var _reflux = __webpack_require__(203);
	...
	var Main = React.createClass({
		...
		mixins: [_reflux2['default'].listenTo(_refluxStore2['default'], "onChange"), _reactRouter.History],

		getInitialState: function getInitialState() {
			return _refluxStore2['default'].getInitialState();
		},
		...
		render: function render() {
			return React.createElement(
				'div',
				{ id: 'alertsui', className: 'container' },
				React.createElement(
					'h1',
					null,
					'Hi from Pushie!'
	...
	var Store = _reflux2['default'].createStore({
		...
		registerServiceWorker: function registerServiceWorker() {
			if ('serviceWorker' in navigator) {
				navigator.serviceWorker.register('/service-worker.js').then(this.initNotifications)['catch'](function (err) {
					console.warn("registration error: er");
				});
			} else {
		...
		initNotifications: function initNotifications() {
			console.log("registration done and initnotif");
...
/***/ function(module, exports, __webpack_require__) {
	...
	Reflux.ActionMethods = __webpack_require__(205);

	Reflux.ListenerMethods = __webpack_require__(206);

	Reflux.PublisherMethods = __webpack_require__(216);

	Reflux.StoreMethods = __webpack_require__(215);

	Reflux.createAction = __webpack_require__(217);

	Reflux.createStore = __webpack_require__(211);

	var maker = __webpack_require__(210).staticJoinCreator;
	...
	var _ = Reflux.utils = __webpack_require__(207);
	...
	Reflux.__keep = __webpack_require__(212);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(207),
	    maker = __webpack_require__(210).instanceJoinCreator;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createStore = __webpack_require__(211),
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (definition) {
	    ...
	    var StoreMethods = __webpack_require__(215),
	        PublisherMethods = __webpack_require__(216),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ListenerMethods = __webpack_require__(206),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Actions = _reflux2["default"].createActions(["submitAlert", "filterModels"]);
